...
bool extractOptionalBNParams(
  ...
  if (bn.hasattr("eps")) {
    ...
    auto optional_eps = toIValue(match.values_map.at(bn_vmap.at("eps")));
    if(!optional_eps) {
      return false;
    }
  ...
  if (bn.hasattr("weight")) {
    ...
    auto optional_bn_weight = toIValue(match.values_map.at(bn_vmap.at("weight")));
  ...
  if (bn.hasattr("bias")) {
    ...
    auto optional_bn_bias = toIValue(match.values_map.at(bn_vmap.at("bias")));
    if (!optional_bn_bias) {
      return false;
    }
